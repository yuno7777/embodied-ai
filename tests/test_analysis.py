...
def test_trajectory_filters_and_offline_replay_verification():
    ...
    replay={"snapshot":{"run_id":"r","step":1},"timeline":[{"run_id":"r","step":0},{"run_id":"r","step":1}],"observations":[{},{}],"events":[],"decisions":[{}]}
...
def test_replay_verifier_accepts_external_interrupt_without_a_simulation_step():
    ...
    replay = {"snapshot": final, "timeline": [initial, final], "observations": [{"step": 0}, {"step": 0}]}
...
def test_replay_verifier_rejects_corruption(corruption):
    ...
    replay = {"snapshot": dict(final), "timeline": [initial, final], "observations": [{"step": 0}, {"step": 1}]}
