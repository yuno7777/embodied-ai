...
`compare-generalization` compares split metrics and held-out gaps only after verifying complete provenance: report and engine versions, sensor mode, seed distribution, and generator configuration. It rejects missing or incompatible metadata instead of producing misleading deltas.
