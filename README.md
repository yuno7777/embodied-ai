...
`compare-generalization` compares split metrics and held-out gaps only after verifying identical report version, engine version, sensor mode, seed distribution, and generator configuration. It rejects incompatible reports instead of producing misleading deltas.
